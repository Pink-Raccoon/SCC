...
for i in range(n):
    ...
    moon = am.rotate_around_point(moon,ce[0],ce[1],moon_rotate)
    ce_list.append(ce)
    cr_list.append(cr) 
    moon_list.append(moon)            # generate coordinates
...
def init():
    ...
    return center_dot, earth_plot, moon_plot,
...
def update(frame):
    ...
    moon_plot.set_data(moon_frame[0],moon_frame[1])
