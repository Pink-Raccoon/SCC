import calculate_border_task1 as tk1
import script_mmi_task2 as tk2
import calculate_polar_coordinates_task4 as tk4
...
# cropped_img_cl,cropped_img_gs,cropped_img_mask,border= tk1.calculate_border_task1("./B496a.png",0.1,5)
# x_center =359

# y_center = 290
# r, alpha, r_sort, alpha_sort, alpha_index, r_bin, alpha_bin= tk4.calculate_polar_coordinates_task4(x_center, y_center, border)
