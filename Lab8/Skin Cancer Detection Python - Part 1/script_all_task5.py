...
os.chdir("C:\\Users\\ashas\\ZHAW_Code\\SCC\\Lab8\\Skin Cancer Detection Python - Part 1")
...
# 1) Define paths
path_nevi = 'C:/Users/ashas/ZHAW_Code/SCC/Lab8/Skin Cancer Detection Python - Part 1/Images Nevi'
path_melanoma = 'C:/Users/ashas/ZHAW_Code/SCC/Lab8/Skin Cancer Detection Python - Part 1/Images Melanoma'
...
for k in np.arange(0,num_pic_nevi): 
    ...
    [cropped_img_cl,cropped_img_gs,cropped_img_mask,border] = calculate_border_task1(path_img, crop_factor_nevi, sigma)
